...
export default function App() {
    const annoncuments = useAnnoncuments(state => state.addAnnoncuments)
    ...
    const renderCell = React.useCallback((user: IAnnouncement, columnKey: React.Key) => {
        const cellValue = user[columnKey as keyof IAnnouncement];
        ...
        return (
            <div className="flex flex-col gap-4">
                ...
                <div className="flex justify-between items-center">
                    <span className="text-black font-bold text-small">Jami {users.length} E&apos;lon</span>
    ...
    return (
        <>
            <h1 className="text-3xl font-bold p-5 text-gray-500">E&apos;lonlar bazasi</h1>
            <Table
